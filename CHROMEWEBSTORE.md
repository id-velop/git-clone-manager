...
|---|---|---|---|
| 1.1.5 setup revision | 2026-09-11 | Shows both Mac and Windows screenshots in the first step of the three-step setup guide and shows the install command directly without a collapsible heading. | Draft |
