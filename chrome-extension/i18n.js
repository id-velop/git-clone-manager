...
(() => {
  ...
  "Ask each time on repository pages": "在仓库页面每次询问",
  ...
  "You can still choose a different folder from Instant Clone.": "克隆时仍可选择其他文件夹。",
  "Terminal": "终端",
  ...
  "Instant Clone": "快速克隆",
  "How should we connect?": "选择连接协议",
  "Remember my choice": "记住我的选择",
  "Change this later from the extension popup.": "可在扩展弹窗中修改。",
  "Cloning…": "克隆中…",
  "Cloned!": "已克隆",
  "No Server": "服务未连接",
  "Failed": "失败",
