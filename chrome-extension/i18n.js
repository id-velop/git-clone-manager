...
(() => {
  ...
  "Copy the command below, paste it into Command Prompt, then press Enter.": "复制下方命令，粘贴到命令提示符，然后按 Enter。",
  ...
  "Copy command": "复制命令",
  "Reconnect": "重新连接",
  "Installs Node.js and Git if needed. May ask for your Mac password.": "自动安装缺少的 Node.js 和 Git，可能需要输入 Mac 密码。",
  "macOS · Installs Node.js and Git if needed. May ask for your Mac password.": "适用于 macOS · 自动安装缺少的 Node.js 和 Git，可能需要输入 Mac 密码。",
  "Installs Node.js and Git if needed. No manual configuration required.": "自动安装缺少的 Node.js 和 Git，无需手动配置。",
  ...
  "Copied. Paste into Command Prompt.": "已复制，请粘贴到命令提示符运行。",
